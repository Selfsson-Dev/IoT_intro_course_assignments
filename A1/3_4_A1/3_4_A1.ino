...
void loop()
{
  for (int currentNote = 0; currentNote < 32; currentNote++) {
    int currentNoteDuration = 1000 / noteDurations[currentNote];
    Serial.println("currentNoteDuration: ");
    Serial.print(currentNoteDuration);

    tone(buzzerPin, melody[currentNote], currentNoteDuration);
    Serial.println(" ");
    Serial.println("Playing note: ");
    Serial.print(melody[currentNote]);

    int pauseBetweenNotes = currentNoteDuration * 1.30;

    Serial.println(" ");
    Serial.println("Added pause: ");
    ...
    noTone(buzzerPin);
    Serial.println(" ");
    Serial.println("Killed last tone");
  }
}